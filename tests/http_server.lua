...
spawn_timeout(function()
  ...
  local function post_helper(payload)
    local response =
      Astra.http.request("http://localhost:" .. PORT .. "/posts"):set_method("POST"):set_json(payload):execute()
  ...
  local function get_helper(uri)
    local response = Astra.http.request(uri):set_method("GET"):execute()
  ...
  local function put_helper(id, payload)
    local response = Astra.http
      .request("http://localhost:" .. PORT .. "/posts/" .. tostring(id))
      :set_method("PUT")
      :set_json(payload)
      :execute()
  ...
  local function del_helper(uri)
    local response = Astra.http.request(uri):set_method("DELETE"):execute()
